...
public class uploadFile extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            //String path = this.getClass().getResource("/").getPath().replaceFirst("out/artifacts/chenhui_war_exploded/WEB-INF/classes/", "web/")+"picture/" + userName;
            ...
            //更新userInfo表
            String sql = "insert into userInfo(id,nickName,des) values(?,?,?)";
            ...
            ps.executeUpdate();
            //更新photo表
            String sql02 = "insert into photoPath(id,photoPath) values(?,?)";
            PreparedStatement ps02 = conn.prepareStatement(sql02);
            ps02.setInt(1, userId);
            ps02.setString(2, path);
            ps02.executeUpdate();
            ps02.close();
            ps.close();
            response.sendRedirect("chatRoom/lobby.html?loginName=" + session.getAttribute("userName"));
